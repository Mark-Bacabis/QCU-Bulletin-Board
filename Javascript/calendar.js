...
document.querySelector(".prev").addEventListener("click", () => {
  ...
  var prevMonth = document.querySelector(".date h1").innerHTML;
  var currentYear = document.querySelector(".date p").innerHTML;
...
document.querySelector(".next").addEventListener("click", () => {
  ...
  var nextMonth = document.querySelector(".date h1").innerHTML;
  var currentYear = document.querySelector(".date p").innerHTML;
